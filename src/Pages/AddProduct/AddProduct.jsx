...
const AddProduct = () => {
    const { user, userToken,userData } = use(AuthContext);
    ...
    return (
        <>
            ...
            <div className='py-5 mx-5 px-3 mt-10 flex flex-col items-center min-h-screen bg-white-bg font-inter'>
                ...
                <p className='tf_heading font-playfair text-black text-3xl font-bold text-center mb-5'>ADD NEW PRODUCT</p>
                <form className='w-full max-w-[500px]' onSubmit={handleAddProduct}>
                    ...
                    <div className='flex flex-col mb-[24px]'>
                        ...
                        <input type="text" className="input bg-fafafa-bg px-[14px] py-[19px] w-full text-[1rem] rounded-lg border border-gray-200 focus:outline-none focus:border-gray-300" name="productName" placeholder="Enter product name" required />
                    </div>
                    {/* Category */}
                    <div className='flex flex-col mb-[24px]'>
                    ...
                    <div className='flex flex-col mb-[24px]'>
                        ...
                        <input type="number" className="input bg-fafafa-bg px-[14px] py-[19px] w-full text-[1rem] rounded-lg border border-gray-200 focus:outline-none focus:border-gray-300" name="price" placeholder="Enter price" min={10} required />
                    </div>
                    {/* Available Quantity */}
                    <div className='flex flex-col mb-[24px]'>
                        <label className="label mb-[8px] font-medium text-black">Available Quantity</label>
                        <input type="number" className="input bg-fafafa-bg px-[14px] py-[19px] w-full text-[1rem] rounded-lg border border-gray-200 focus:outline-none focus:border-gray-300" name="availableQuantity" placeholder="Enter available quantity" min={10} required />
                    </div>
                    {/* Minimum Order Quantity */}
                    <div className='flex flex-col mb-[24px]'>
                        <label className="label mb-[8px] font-medium text-black">Minimum Order Quantity</label>
                        <input type="number" className="input bg-fafafa-bg px-[14px] py-[19px] w-full text-[1rem] rounded-lg border border-gray-200 focus:outline-none focus:border-gray-300" name="minimumOrderQuantity" placeholder="Enter minimum order quantity" min={10} required />
                    </div>
                    {/* Payment Option */}
                    <div className='flex flex-col mb-[24px]'>
                    ...
                    <div className='flex flex-col mb-[24px]'>
                        ...
                        <textarea placeholder="Enter product description" className="textarea textarea-xl w-full bg-fafafa-bg px-[14px] py-[19px] text-[1rem] rounded-lg border border-gray-200 focus:outline-none focus:border-gray-300 resize-none" name="productDescription"></textarea>
                    ...
                    <div className='flex flex-col mb-[24px]'>
                        ...
                        <input
                            ...
                            className="file-input bg-fafafa-bg w-full"
                            required />
                    </div>
